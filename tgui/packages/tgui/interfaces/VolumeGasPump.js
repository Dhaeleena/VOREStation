...
export const VolumeGasPump = (props, context) => {
          ...
          <LabeledControls>
            <LabeledControls.Item>
              <Button
                ...
                content="MIN"
                onClick={() => act("set_flow", { flow: "min" })} />
              <Button
                icon="expand-arrows-alt"
                content="MAX"
                onClick={() => act("set_flow", { flow: "max" })} />
              <Button
                icon="wrench"
                content="SET"
                onClick={() => act("set_flow", { flow: "set" })} />
            </LabeledControls.Item>
            <LabeledControls.Item label="Desired Output Flow">
              {flow_set / 10} L/s
            </LabeledControls.Item>
          </LabeledControls>
        </Section>
