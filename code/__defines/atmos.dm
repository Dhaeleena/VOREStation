...
#define ATMOSTANK_PHORON        50000
#define ATMOSTANK_NITROUSOXIDE  25000 // N2O doesn't have a real useful use, i guess it's on station just to allow refilling of sec's riot control canisters?
